...
"https://www.freepnglogos.com/uploads/twitter-logo-png/twitter-logo-vector-png-clipart-1.png" 
    ...
    <body>
        <div x-data="{dropdownMenu: false}" class="relative">
            ...
            <button @click="dropdownMenu = ! dropdownMenu" class="flex items-center p-2 bg-white bg-gray-100 rounded-md mt-20">
        ...
        <select id="form_dob_month" name="dob_month">
         ...
         <select id="form_dob_day" name="dob_day" class="bg-blue-800">
            <option value="-">-</option>
