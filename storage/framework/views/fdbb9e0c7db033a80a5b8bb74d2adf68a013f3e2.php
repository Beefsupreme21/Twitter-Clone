    ...
    <div style="width: 900px;" class="container max-w-full mx-auto pt-4">
        <form method="POST" action="/posts/<?php echo e($post->id); ?>">
            ...
            <div class="mb-4">
                ...
                <input class="h-10 bg-white border border-gray-300 rounded py-4 px-3 mr-4 w-full text-gray-600 text-sm focus:outline-none focus:border-gray-400 focus:ring-0" id="title" name="title" value="<?php echo e($post->title); ?>">
            </div>

            <div class="mb-4">
                <label class="font-bold text-gray-800" for="content">Content: </label>
                <textarea class="h-16 bg-white border border-gray-300 rounded py-4 px-3 mr-4 w-full text-gray-600 text-sm focus:outline-none focus:border-gray-400 focus:ring-0" id="content" name="content"><?php echo e($post->content); ?></textarea>
            </div>
...
</html><?php /**PATH C:\xampp\Projects\laravel-student\resources\views/posts/edit.blade.php ENDPATH**/ ?>