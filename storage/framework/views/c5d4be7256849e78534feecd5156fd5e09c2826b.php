        ...
        <a href="/posts/<?php echo e($post->id); ?>">
            <article class="border-b border-x border-gray-700 px-3 py-3 text-white text-base hover:bg-slate-800">
                    ...
                    <div class="flex justify-around pt-4 px-6 text-slate-400">
                        ...
                        <?php $__currentLoopData = $retweets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $retweet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        


                        <?php if($retweet->user_id == auth()->id() && $post->id == $retweet->post_id): ?>
