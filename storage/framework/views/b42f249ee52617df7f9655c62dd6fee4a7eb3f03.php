        ...
        <a href="#">
            <article class="border-b border-x border-gray-700 px-3 py-3 text-white text-base hover:bg-slate-800">
                    ...
                    <div class="flex">
                        ...
                        <div class="pl-4">
                            <div class="flex">
                                <a href="/posts/<?php echo e($post->id); ?>/edit" class="font-bold"><?php echo e($post->name); ?></a> 
                                ...
                                <p class="text-gray-400"><?php echo e($post->handle); ?> · 2h</p> 
                            </div>
                    ...
                    <div class="flex justify-around pt-4 px-6 text-slate-400">
                        <div class="flex hover:text-cyan-500">
                            ...
                            <p class="pl-3"><?php echo e($post->replies); ?></p> 
                        </div>
                        ...
                        <div class="flex hover:text-cyan-500">
                            ...
                            <p class="pl-3"><?php echo e($post->retweets); ?></p> 
                        </div>
...
<?php endif; ?><?php /**PATH C:\xampp\Projects\laravel-student\resources\views/posts/index.blade.php ENDPATH**/ ?>