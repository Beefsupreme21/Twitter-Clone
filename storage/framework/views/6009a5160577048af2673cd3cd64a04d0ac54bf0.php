    ...
    <div class="container mx-auto md:w-[600px] border-x border-gray-700">
        ...
        <div>
            <div class="w-full h-full">
                <img src=<?php echo e(asset('images/tdfw.jpg')); ?> alt="">
            </div>
            <div class="relative bottom-20 ml-5 w-1/3 -mb-20">
                <?php if($user->image): ?>
                    <img src="<?php echo e($user->image ? asset('storage/' . $user->image) : asset('images/default_profile.png')); ?>" class="rounded-full picture-background" alt="">
                <?php else: ?>
        ...
        <div>
            <a href="/<?php echo e($user->name); ?>" class="font-bold hover:underline"><?php echo e($user->name); ?></a> 
            <div class="flex">
                <p class="ml-1 text-gray-400">@</p>
                <p class="text-gray-400"><?php echo e($user->handle); ?></p> 
            </div>
